...
ms.locfileid: "87868816"
---
# <a name="quantum-algorithms"></a>クォンタムアルゴリズム #

## <a name="amplitude-amplification"></a>振幅増幅 ##

*振幅増幅*は、クォンタムコンピューティングの基本的なツールの1つです。 これは、Grover の検索、振幅推定、および多くのクォンタム機械学習アルゴリズムを基盤とする基本的なアイデアです。  さまざまなバリエーションがありますが、では、 Q# アプリケーションの最も広い領域を実現するために部分的な反射を伴う無関係の振幅増幅に基づいて、一般的なバージョンを提供しています。
