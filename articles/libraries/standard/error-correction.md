...
具体的には、ビットフリップエラーによって、真ん中の qubit に対して _1 $ act $X します。両方の分岐で必要な修正は、正確に $X _1 $: $ $ \begin{align} X_1 \ket{\overline{+}} & = \ frac{1}{/sqrt{2}} \ left (X_1 \ket{000} + X_1 \ket{111} 右) \\\\ & = (\ket{1}+ \ket{2}/right) であることがわかります。{010}{101}
\end{align} $ $
