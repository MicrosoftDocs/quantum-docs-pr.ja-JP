...
### <a name="encoder--littleendian--unit-adj--ctl"></a>エンコーダー: [LittleEndian](xref:Microsoft.Quantum.Arithmetic.LittleEndian) => [Unit](xref:microsoft.quantum.lang-ref.unit) 形容詞 + Ctl
