...
---
# <a name="todouble-function"></a>ToDouble 関数
...
> [!WARNING]
> ToDouble は非推奨とされます。 代わりに、<xref:Microsoft.Quantum.Convert.IntAsDouble> を使用してください。
>
> @"microsoft.quantum.convert.intasdouble" を使用してください。
