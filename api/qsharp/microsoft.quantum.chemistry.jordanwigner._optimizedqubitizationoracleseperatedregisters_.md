...
---
# <a name="_optimizedqubitizationoracleseperatedregisters_-function"></a>_OptimizedQubitizationOracleSeperatedRegisters_ 関数
...
## <a name="output--intintdoublequbitqubit--unit-adj--ctl"></a>出力: (([int](xref:microsoft.quantum.lang-ref.int),[int](xref:microsoft.quantum.lang-ref.int)), ([Double](xref:microsoft.quantum.lang-ref.double), ([qubit](xref:microsoft.quantum.lang-ref.qubit)[],[qubit](xref:microsoft.quantum.lang-ref.qubit)[]) => [単位](xref:microsoft.quantum.lang-ref.unit) の形容詞 + Ctl))
